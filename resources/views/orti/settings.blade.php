            ...
            <div class="settings-grid">
                ...
                <div class="glass-card settings-nav-card">
                    <ul class="settings-nav">
                        ...
                        <li class="settings-nav-item">
                            <a href="{{ route('settings') }}#security" class="settings-nav-link" data-tab="security">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <div class="settings-section">
                            ...
                            <div class="settings-row">
                                <div class="settings-label">
                                    ...
                                    <span class="settings-label-desc">Add an extra layer of security to your
                                        account</span>
                                </div>
                        ...
                        <div class="settings-section">
                            ...
                            <div class="settings-row">
                                <div class="settings-label">
                                    ...
                                    <span class="settings-label-desc">Get notified about sign-ins and security
                                        changes</span>
                                </div>
                                <label class="toggle-switch">
                                    <input type="checkbox" checked>
                        ...
                        <div class="settings-section">
                            ...
                            <div class="billing-plan-card"
                                ...
                                <div style="display: flex; gap: 12px;">
                                    <button class="btn btn-primary" style="width: auto; padding: 10px 20px;">Upgrade
                                        Plan</button>
                                    <button class="btn btn-secondary" style="width: auto; padding: 10px 20px;">Cancel
                                        Subscription</button>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="data-table" style="min-width: 100%;">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="#" style="color: var(--emerald-light);">Download</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Dec 1, 2024</td>
